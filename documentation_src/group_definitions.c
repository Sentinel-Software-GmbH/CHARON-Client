 ...
 * @brief The Modules where all the translating work happens.
 * 
 ...
 * @brief Data definition modules.
 * 
 * @defgroup TestModules Test Modules
 * @brief Unit Tests for ceedling.
 * 
 * @defgroup Config Configuration Modules
 * @brief All header files where the Library can be configured.
 * @}
 */