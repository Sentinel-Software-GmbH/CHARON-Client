 ...
 * @param rxBufferLength length of rxBuffer.
 */
public void UDS_Client_Init(const ComInterface *com, TimerInterface *timer, SecurityInterface *security, uint8_t * const rxBuffer, uint32_t rxBufferLength);

/** @brief Cyclic Task that receives Messages and handles KeepAlives.
 * @returns The last error code that has occurred. See @ref UDS_Client_Error_t.
 */ 
